...
# James Crockett, 2021-Nov-15, Added comment block of objectives, lines 10-13. Outline 
#                              code that needs to be written using pseudo code.
# James Crockett, 2021-Nov-20, Updated and implemented Class methods into main, smoke 
#                              tested, and fixed runtime errors
# James Crockett, 2021-Nov-21, Updated method doc strings.
#--------------------------------------------------------------------------------------------------#

# Modify the script as required to organize the code. 
# There are several TODOs in the code. It is your assignment to resolve these 
# and finish organizing the code.
# Don’t overlook to add docstrings and add your involvement to the header.
...
while True:
    ...
    # 3.3 process add a CD
        ...
        # unpack tuple, varibles to be access by add_cd method
